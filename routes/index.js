...
router.post('/album/:id/delete', album_controller.album_create_post);
...
router.post('/artist/:id/delete', artist_controller.artist_create_post);
...
router.post('/release/:id/delete', format_controller.format_create_post);
...
router.get('/label/create', label_controller.label_delete_get);

router.post('/label/create', label_controller.label_create_post);

router.get('/label/:id/delete', label_controller.label_delete_get);

router.post('/label/:id/delete', label_controller.label_create_post);
